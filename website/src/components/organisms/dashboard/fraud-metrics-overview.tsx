  ...
  return (
    <div className={cn('grid grid-cols-1 lg:grid-cols-3 gap-6 items-stretch', className)}>
      ...
      <div className="lg:col-span-1 flex flex-col gap-4 h-full">
        {/* Total Transactions */}
        <div className="bg-card border border-border rounded-lg p-6 flex-1 flex flex-col justify-center">
      ...
      <div className="lg:col-span-2 flex h-full">
        <div className="bg-card border border-border rounded-lg p-6 flex flex-col w-full">
